...
entity function TreasureBoxCreate( vector origin, vector angles )
{
	...
	SetCallback_CanUseEntityCallback_Retail( treasureModel, SurvivalBasicUsable_CanUseFunction )
...
void function TreasureButtonUseThink( entity ent, entity playerUser )
{
	...
	settings.successFunc = void function(entity panel, entity player, ExtendedUseSettings s)
	{
		OnTreasureButtonUseSuccess_Untyped(panel, player)
...
void function OnTreasureButtonUseSuccess_Untyped( entity panel, entity player)
{
	#if SERVER
